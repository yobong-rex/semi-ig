...
@endphp
    <button id="upgrade_a">Upgrade Komponen A</button><br>
    <button id="upgrade_b">Upgrade Komponen B</button><br>
    <button id="upgrade_c">Upgrade Komponen C</button><br>
    <button id="upgrade_d">Upgrade Komponen D</button><br>
</body>
@endsection